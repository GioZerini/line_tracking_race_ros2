...
# === Differenze principali ROS 1 → ROS 2 ===
# - rospy → rclpy: sostituita l'importazione e le API di logging/shutdown.
# - rospy.logwarn/logerr → node.get_logger().warn()/error()
# - rospy.signal_shutdown() → rclpy.shutdown()
# - Ogni nodo ROS 2 viene passato esplicitamente come oggetto al costruttore della classe.
# - Nessun uso implicito di nodi globali: logging, parametri e shutdown devono passare dal nodo.
# - CvBridge e OpenCV rimangono identici tra ROS 1 e ROS 2.
